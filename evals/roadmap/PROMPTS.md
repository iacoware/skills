...
Tratta evals/roadmap/recipe-app/results/manual-run-1/ come project root.
...
- Tutto il resto di evals/ è off limits in lettura: puoi solo scriverci dentro.
  ...
  SCENARIOS, PROMPT.md, README.md, AGENTS.md o altri results/ di run
  precedenti.
...
L'obiettivo di questa sessione è migliorare @skills/roadmap/SKILL.md. Se leggi il risultato di un run manuale @evals/roadmap/recipe-app/results/manual-run-1/ROADMAP.md generato dal prompt presente in @evals/roadmap/PROMPTS.md vedrai che non ha generate le slices in documenti a parte come previsto. Puoi usare @evals/roadmap/recipe-app/reference-roadmap/ come comparazione di quello che avrebbe dovuto fare.

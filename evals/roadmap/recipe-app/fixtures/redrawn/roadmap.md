...
| S13 | [Ricerca su tutto il corpus pubblico](slices/S13-ricerca-corpus-pubblico.md) | scoperta | product | medium | ready | agent | S12 |
...
- `scoperta` — I duplicati restano consentiti: due ricettari pubblici che linkano la stessa pagina
  ...
  è piccolo; il prezzo cresce con la scoperta ed è scritto nell'esclusione.

...
| Modello | `opus` |
| Effort | `high` |
| Session id | `1a845a94-227e-4b84-a3ae-86cc1011e770` |
| Commit | `3fc0293 Record the roadmap-log decisions taken on landing` |
| `skills/roadmap` | tree `132d4e7`, uguale a HEAD |
...
Tratta evals/roadmap/recipe-app/results/ROADMAP-CC-7/ come project root; crea la directory prima.

...
su ricette vere salvate dalle righe precedenti. Una ricetta di un altro ricettario non esce mai. Se
...
- Filtri per tag e tempo, ricerca ibrida, ricerca che attraversa più ricettari: restano candidati.
  I campi si popolano già da `S4` e `S5`, così i filtri non chiederanno una migrazione.

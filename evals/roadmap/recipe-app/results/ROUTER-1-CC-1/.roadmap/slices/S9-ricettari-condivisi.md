...
ricettari vede in elenco solo le ricette del ricettario corrente, e cambiando ricettario vede le
altre; lo scope della ricerca non è di questa riga ma di `S7` e `S12`. Chi non è membro non apre un
ricettario nemmeno conoscendone l'id. Il creator non ha
...
- Un concetto di gruppo sopra i ricettari e ricettari pubblici tematici: restano candidati.
- La ricerca che attraversa i ricettari di cui si è membri: è di `S12`, che segue questa riga.

...
| Modello | `opus` |
| Effort | `high` |
| Session id | `93bf4e15-9c8e-4f0f-a57b-cc56466ec437` |
...
Tratta ./evals/roadmap/recipe-app/results/ROADMAP-CC-6B/ come project root; crea la directory prima.

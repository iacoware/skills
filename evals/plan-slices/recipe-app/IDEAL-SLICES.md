...
Ricerca, Consultazione, Scrittura manuale, Import automatico, Foto, Accesso, Condivisione.
...
-   2. Creazione e view di un ricettario in home nell'elenco dei ricettari. Detail del ricettario che ovviamente è vuoto.
-   3. Costruzione della pipeline di processazione delle ricette. Data una ricetta "normalizzata" ne estrae gli embedding e li salva su PG. Aggiungere la possibilità di fare il seed di 3 ricette fixture. Passo necessario per testare la ricerca
-   4. Ricerca semantica cross-lingua (pomodoro, ricetta veloce vegetariana). Vincolata al cookbookId corrente
-   5. Autenticazione utente. I ricettari sono privati, senza condivisione gli utenti non si vedono i ricettari a vicenda

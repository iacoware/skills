...
- **`Remedy`, and the rule that governs it.** When the entry names an existing clause, the default
  ...
  _«The clause is covered by a ledger row»_ is not an admissible reason — covered clauses are the
...
Write exactly one file, at `/Users/iacoware/projects/iacoware/skills/evals/plan-slices/recipe-app/payloads/CON-6/out/PLAN-CX-CON-6.IMPROVEMENT.md`, titled `# Improvement report — cycle CON-6`.
